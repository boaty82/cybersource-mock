...
VALUES
  ...
  (4, 'ACCEPT', 'ACCEPT', 'Cukes-3', 'Cukes Test', 'test@cukes.com', 'AUTH', 'ACCEPT' , '1 Test St', 'Line 2', 'XX1 1XX', 'London', 'UK', 202512, '1234123412341234', 'VISA', 'GBP', '127.0.0.1', 'en', 'card', TRUE, 'create_payment_token','default');
